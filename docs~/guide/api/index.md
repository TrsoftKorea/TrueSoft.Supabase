...
- [**쿠폰**<br><small>코드 사용 · 우편 보상</small>](/guide/api/coupon)
- [**채팅**<br><small>채널 구독 · 발송 · 귓속말</small>](/guide/api/chat)
- [**친구**<br><small>검색 · 요청 · 목록</small>](/guide/api/friend)
- [**매치 로비**<br><small>친구 초대 · 시작 · 취소</small>](/guide/api/match-lobby)
