...
namespace TrueBase.Unity.Config
{
    ...
    internal sealed class SupabaseUnityBootstrap
    {
        ...
        public SupabaseFriendService FriendService { get; private set; }
        public SupabaseMatchLobbyService MatchLobbyService { get; private set; }
        ...
        public void Initialize(SupabaseSettings settings)
        {
            ...
            MatchResultService = new SupabaseMatchResultService(
                options.ProjectURL,
                options.PublishableKey,
                http);
            ...
            FriendService = new SupabaseFriendService(
                options.ProjectURL,
                options.PublishableKey,
                http);

            MatchLobbyService = new SupabaseMatchLobbyService(
                options.ProjectURL,
                options.PublishableKey,
                http);
