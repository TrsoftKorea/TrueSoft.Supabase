namespace TrueBase.Core.Common
{
    ...
    public enum SupabaseReason
    {
        ...
        MatchResultMismatch,
        FriendNicknameEmpty,
        FriendNicknameNotFound,
        FriendSelfRequest,
        FriendTargetRequired,
        FriendAlreadyFriends,
        FriendRequestAlreadySent,
        FriendDirectionInvalid,
        FriendRequestNotFound,
        FriendRequestNotPending,
        FriendNotFound,
        FriendLimitReached,
        FriendTargetLimitReached,
        FriendPendingLimitReached,
        FriendRequestTooFast,
        FriendSettingsMissing,
        MatchLobbyInviteLimitReached,
        MatchLobbyInviteTooFast,
        MatchLobbySettingsMissing,
        MatchLobbyNotFound,
        MatchLobbyNotOpen,
        MatchLobbyFull,
        MatchLobbyInviteNotFound,
        MatchLobbyMemberNotFound,
        MatchLobbyMaxMembersInvalid,
        MatchLobbyNameTooLong,
    }
    ...
    public static class SupabaseReasonMap
    {
        ...
        public static SupabaseReason FromErrorCode(string errorCode) => errorCode switch
        {
            ...
            SupabaseErrorCode.ServerCodeEmpty => SupabaseReason.ServerCodeEmpty,
            ...
            SupabaseErrorCode.TableNameEmpty => SupabaseReason.TableNameEmpty,
            ...
            SupabaseErrorCode.MailNotFound => SupabaseReason.MailNotFound,
            SupabaseErrorCode.Forbidden => SupabaseReason.Forbidden,
            SupabaseErrorCode.ForbiddenServer => SupabaseReason.ForbiddenServer,
            SupabaseErrorCode.MailDeleted => SupabaseReason.MailDeleted,
            SupabaseErrorCode.MailExpired => SupabaseReason.MailExpired,
            SupabaseErrorCode.AlreadyClaimed => SupabaseReason.AlreadyClaimed,
            SupabaseErrorCode.InvalidItemsPayload => SupabaseReason.InvalidItemsPayload,
            SupabaseErrorCode.CannotDeleteUnclaimed => SupabaseReason.CannotDeleteUnclaimed,
            ...
            SupabaseErrorCode.IapOrderIdEmpty => SupabaseReason.IapOrderIdEmpty,
            ...
            SupabaseErrorCode.LeaderboardRotationClosed => SupabaseReason.LeaderboardRotationClosed,
            ...
            SupabaseErrorCode.LeaderboardScoreRequired => SupabaseReason.LeaderboardScoreRequired,
            ...
            SupabaseErrorCode.FriendNicknameEmpty => SupabaseReason.FriendNicknameEmpty,
            SupabaseErrorCode.FriendNicknameNotFound => SupabaseReason.FriendNicknameNotFound,
            SupabaseErrorCode.FriendSelfRequest => SupabaseReason.FriendSelfRequest,
            SupabaseErrorCode.FriendTargetRequired => SupabaseReason.FriendTargetRequired,
            SupabaseErrorCode.FriendAlreadyFriends => SupabaseReason.FriendAlreadyFriends,
            SupabaseErrorCode.FriendRequestAlreadySent => SupabaseReason.FriendRequestAlreadySent,
            SupabaseErrorCode.FriendDirectionInvalid => SupabaseReason.FriendDirectionInvalid,
            SupabaseErrorCode.FriendRequestNotFound => SupabaseReason.FriendRequestNotFound,
            SupabaseErrorCode.FriendRequestNotPending => SupabaseReason.FriendRequestNotPending,
            SupabaseErrorCode.FriendNotFound => SupabaseReason.FriendNotFound,
            SupabaseErrorCode.FriendLimitReached => SupabaseReason.FriendLimitReached,
            SupabaseErrorCode.FriendTargetLimitReached => SupabaseReason.FriendTargetLimitReached,
            SupabaseErrorCode.FriendPendingLimitReached => SupabaseReason.FriendPendingLimitReached,
            SupabaseErrorCode.FriendRequestTooFast => SupabaseReason.FriendRequestTooFast,
            SupabaseErrorCode.FriendSettingsMissing => SupabaseReason.FriendSettingsMissing,
            SupabaseErrorCode.MatchLobbyInviteLimitReached => SupabaseReason.MatchLobbyInviteLimitReached,
            SupabaseErrorCode.MatchLobbyInviteTooFast => SupabaseReason.MatchLobbyInviteTooFast,
            SupabaseErrorCode.MatchLobbySettingsMissing => SupabaseReason.MatchLobbySettingsMissing,
            SupabaseErrorCode.MatchLobbyNotFound => SupabaseReason.MatchLobbyNotFound,
            SupabaseErrorCode.MatchLobbyNotOpen => SupabaseReason.MatchLobbyNotOpen,
            SupabaseErrorCode.MatchLobbyFull => SupabaseReason.MatchLobbyFull,
            SupabaseErrorCode.MatchLobbyInviteNotFound => SupabaseReason.MatchLobbyInviteNotFound,
            SupabaseErrorCode.MatchLobbyMemberNotFound => SupabaseReason.MatchLobbyMemberNotFound,
            SupabaseErrorCode.MatchLobbyMaxMembersInvalid => SupabaseReason.MatchLobbyMaxMembersInvalid,
            SupabaseErrorCode.MatchLobbyNameTooLong => SupabaseReason.MatchLobbyNameTooLong,
