namespace TrueBase.Core.Common
{
    ...
    public static class SupabaseReasonMap
    {
        ...
        public static SupabaseReason FromErrorCode(string errorCode) => errorCode switch
        {
            ...
            SupabaseErrorCode.UserSaveNoChanges => SupabaseReason.UserSaveNoChanges,
            SupabaseErrorCode.UserSaveNotReady => SupabaseReason.UserSaveNotReady,
            SupabaseErrorCode.UserSaveTimeout => SupabaseReason.UserSaveTimeout,
            SupabaseErrorCode.UserSaveSerializeFailed => SupabaseReason.UserSaveSerializeFailed,
