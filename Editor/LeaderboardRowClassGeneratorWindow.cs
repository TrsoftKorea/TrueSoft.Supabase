...
namespace TrueBase.Editor
{
    ...
    internal sealed class LeaderboardRowClassGeneratorWindow : EditorWindow
    {
            ...
            string leaderboardCode)
        {
            ...
            // ILeaderboardRow — Supabase.SubmitLeaderboardScoreAsync(score, row) 처럼 행을 그대로 넘길 수 있게 합니다.
            sb.AppendLine(ind + "public sealed partial class " + className + " : ILeaderboardRow");
            sb.AppendLine(ind + "{");
            ...
            sb.AppendLine();
            sb.AppendLine(ind + "    string ILeaderboardRow.LeaderboardCode => LeaderboardCode;");
            sb.AppendLine();
