...
namespace Truesoft.Supabase.Editor
{
    ...
    internal static class RemoteConfigClassGenerator
    {
            ...
            IReadOnlyList<string> extraUsings = null)
        {
            ...
            // DTO 클래스
            AppendConfigClass(sb, ind, configClassName, fields, depth: 0);
            sb.AppendLine();

            // 접근자 클래스
            AppendAccessorClass(sb, ind, accessorClassName, configClassName, keyName);
        ...
        private static void AppendAccessorClass(
            ...
            string accessorClass, string configClass, string keyName)
        {
